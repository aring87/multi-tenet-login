...
class App:
    ...
    def build(self):
        ...
        tk.Label(bottom,text="JIT access via CyberQP",bg="#12213a",fg="#b9c8da",font=("Segoe UI",9)).pack(anchor="w",pady=(6,16))
        ...
        self.status=tk.StringVar(value="Ready. Activate JIT access in CyberQP, then sign in with Microsoft.")
        ...
        discovery,body=self.card(connect,"Azure workspace","Activate JIT access, then connect your account.")
        ...
        self.form(body,"OIDC subject format","oidc_subject_format","immutable",["immutable","legacy"])
